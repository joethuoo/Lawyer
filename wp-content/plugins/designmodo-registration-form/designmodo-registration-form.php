...
class Designmodo_registration_form
{
    ...
    {
        wp_enqueue_style('foundation', plugins_url('bower_components/foundation/css/foundation.css', __FILE__));
        wp_enqueue_style('style', plugins_url('stylesheets/style.css', __FILE__));
        wp_enqueue_style('design', plugins_url('stylesheets/new-style.css', __FILE__));
        wp_enqueue_style('jej', plugins_url('stylesheets/app.css', __FILE__));
